...
# -------------------------------------------------------------
    ...
    from io import BytesIO   # <-- keeps it local, or add near top of file
    st.title("View Stored Data")

    # Toggle between structured tickets and raw uploads
    ...
    try:
        ...
        # Info messages when tables are empty
        elif df.empty:
